...
*
*  Barath Kumar Chakravarthy 05/24/2016
**********************************

This ticket service does the following:

=> Allows user to create multiple holds and reservations for one customer.
=> It will hold any available seat within levels user provided and return holdId. 
=> If available seats are not enough in one level, then hold available seat in next level. 
=> There is no limit on number of holding nor on number of seat to hold

This service holds maximum number of available seats upon user request. If the user requests 5 seats and say only 3 are available, it hold seat for 3. If it can't find any available seats, the holdid will be empty.
